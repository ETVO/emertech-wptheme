 ...
 * 
 * CHANGES:
 * Changed function `start_el` to allow any menu item to have the href property set
 * Before that, the dropdown items had no href set
 * 
 * @package Emertech WordPress theme
 * @source https://github.com/wp-bootstrap Custom Bootstrap WP Menu Walker 
 */

/**
 * Emertech Custom Walker class for WP_Menu.
 */
class Emertech_Custom_Walker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
		...
		// EDITED BECAUSE: Make sure that href will be set (if not empty) to any menu item 
		$atts['href'] = ! empty( $item->url ) ? $item->url : '#';
